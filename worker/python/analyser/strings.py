...
def extract_ascii_strings(path: Path, limit: int = 5000) -> list[str]:
...
def analyse_strings(path: Path) -> dict[str, object]:
    ...
    commands = [command for command in SUSPICIOUS_COMMANDS if command in lower]
