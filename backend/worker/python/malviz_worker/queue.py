    ...
    with connect() as conn:
        ...
        try:
            ...
            context = AnalysisContext(
                ...
                analysis_request_id=str(job.get("analysis_request_id") or ""),
                artefact_id=str(job.get("artefact_id") or ""),
                artefact_type=str(job.get("artefact_type") or "FILE"),
                artefact_reference=str(job.get("artefact_reference") or file_id),
